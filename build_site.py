...
def build_index(S, modules):
    ...
    page = (
        ...
        + f'<video class="opening-logo" autoplay loop muted playsinline poster="{S["asset_root"]}assets/media/logo.png" aria-label="MyAIAgent">'
        + f'<source src="{S["asset_root"]}assets/media/logo.mp4" type="video/mp4"></video>'
